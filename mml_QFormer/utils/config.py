...
class ConfigS:
    ...
    max_len: int = 40
    dropout: float = 0.1
    weights_dir: str = "/data/chy/others/MML-Assignment3/results/weights/QFormer_small"
    dataset_len: int = -1
...
class ConfigL:
    ...
    max_len: int = 40
    dropout: float = 0.08
    weights_dir: str = "/data/chy/others/MML-Assignment3/results/weights/QFormer_large"
    dataset_len: int = -1
